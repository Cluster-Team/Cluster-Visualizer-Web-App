$(function() {
    ...
    $(document).ready(function() {
        // Add an event listener to the radio buttons container
        $('#radio-buttons-container').on('change', '.clustering_algo_type', function() {
    ...
    DOMstrings.stepsForm.addEventListener('click', e => {
        ...
        // if (!(eventTarget.classList.contains(`${DOMstrings.stepAffClus}`) || eventTarget.classList.contains(`${DOMstrings.stepDBClus}`) || eventTarget.classList.contains(`${DOMstrings.stepKmeansClus}`))) {
        //     return;
        // }
        ...
        if (eventTarget.classList.contains(`${DOMstrings.stepPrevBtnClass}`) ) {
            ...
            if(activePanelNum==4){
                if(selectedValue=='Affinity Clustering'  ){
                    activePanelNum=1;
                }
                else if(selectedValue=='K Means'){
                    activePanelNum=2;
                }
                else if(selectedValue=='DBSCAN'){
                    activePanelNum=3;
                }
            }
            else{
